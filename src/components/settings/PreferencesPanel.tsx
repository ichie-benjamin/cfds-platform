...
function NotificationsCard() {
  const toggles: ToggleConfig[] = [
    {
      ...
      icon: <Mail className="h-[0.78rem] w-[0.78rem] text-[#3a4556]" />,
      initial: true,
    },
    {
      id: "push",
      ...
      icon: <Smartphone className="h-[0.78rem] w-[0.78rem] text-[#3a4556]" />,
      initial: false,
    },
    {
      id: "sms",
      ...
      icon: <MessageSquare className="h-[0.78rem] w-[0.78rem] text-[#3a4556]" />,
      initial: false,
    },
    {
      id: "price",
      ...
      icon: <LineChart className="h-[0.78rem] w-[0.78rem] text-[#3a4556]" />,
      initial: true,
    },
    {
      id: "trade",
      ...
      icon: <Receipt className="h-[0.78rem] w-[0.78rem] text-[#3a4556]" />,
      initial: true,
    },
    {
      id: "security",
      ...
      icon: <Shield className="h-[0.78rem] w-[0.78rem] text-[#3a4556]" />,
      initial: true,
      locked: true,
    },
  ];
  ...
  return (
    <SectionCard title="Notifications" icon={<Bell className="h-[0.85rem] w-[0.85rem] text-[#00dfa2]" />}>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <span className="grid w-[18px] place-items-center text-center">
          {icon}
        </span>
        <div>
          ...
          <div className="mt-[1px] text-[0.66rem] text-[#4a5468]">{desc}</div>
        </div>
      </div>
      <button
        type="button"
        ...
        aria-pressed={on}
        className={`relative h-[23px] w-[42px] shrink-0 rounded-xl transition-colors duration-[250ms] ${
          on
      ...
      >
        <span
          className={`absolute left-[3px] top-[3px] h-[17px] w-[17px] rounded-full bg-white shadow-[0_1px_4px_rgba(0,0,0,0.2)] transition-transform duration-200 ${
...
function DisplayCard() {
  ...
  return (
    <SectionCard title="Display" icon={<Palette className="h-[0.85rem] w-[0.85rem] text-[#00dfa2]" />}>
      <PillGroup
        label="Chart Type"
        value={chart}
        onChange={setChart}
...
function TradingCard() {
  ...
  const toggles: ToggleConfig[] = [
    {
      ...
      icon: <CheckCheck className="h-[0.78rem] w-[0.78rem] text-[#3a4556]" />,
      initial: true,
    },
    {
      id: "auto",
      ...
      icon: <Bot className="h-[0.78rem] w-[0.78rem] text-[#3a4556]" />,
      initial: false,
    },
  ];
  ...
  return (
    <SectionCard
      ...
      icon={<BarChart3 className="h-[0.85rem] w-[0.85rem] text-[#00dfa2]" />}
    >
      <PillGroup
        ...
        {options.map((opt) => {
          ...
          return (
            <button
              ...
              className={`inline-flex items-center gap-[5px] rounded-lg border px-4 py-2 text-[0.76rem] transition-colors ${
                active
