const TIPS = [
  "Ensure photos are clear and well-lit, blurry images get rejected.",
  "Names on documents must match your account details exactly.",
  "Verification typically processes within 24 to 48 hours.",
];

export function VerificationTipsCard() {
  return (
    <div
